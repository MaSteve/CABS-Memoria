...
\end{align*}
Sobre la traducción del while cabe destacar que es necesario traducir dos veces su condición y el uso de una asignación adicional. Esto es debido, en primer lugar, a que el concepto de while necesita evaluar antes de la ejy, en segundo lugar, a que las funciones de traducción de expresiones booleanas no contemplan la reutilización de variables.\\
